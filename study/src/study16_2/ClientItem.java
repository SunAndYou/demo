    ...
    public static void main(String args[]) {
        ...
        try{ clientSocket=new Socket();
            ...
            if(clientSocket.isConnected()){}
                ...
                InputStream in=clientSocket.getInputStream();//clientSocket 调用 getInputStream()返回输入流
                OutputStream out= clientSocket.getOutputStream();//clientSocket 调用 getOutputStream()返回输出流
