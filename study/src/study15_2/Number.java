...
public class Number implements Runnable {
    ...
    Number() {
        ...
        guessNumberThread1=new Thread(this);//创建guessNumberThread,当前Number类的实例是guessNumberThread的目标对象
    ...
    public synchronized void setMessage(int count) {
        ...
        if(Thread.currentThread()==guessNumberThread1||Thread.currentThread()==guessNumberThread2&&isGiveNumber==true) {
            ...
            if(message==SMALLER) {
                ...
                System.out.println(name+"第"+count+"次猜这个数是:"+guessNumber);
            }
